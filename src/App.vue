  ...
  <div class="app-container flex flex-col lg:flex-row h-screen w-screen overflow-hidden bg-surface-secondary">
    ...
    <div class="map-area flex-1 relative min-h-[50vh] lg:min-h-0">
      ...
      <button
        ...
        :class="[
          'absolute bottom-32 right-4 lg:bottom-6 lg:right-[300px] z-50 flex items-center gap-2 px-3 py-2 bg-red-500 text-white rounded-full shadow-lg hover:bg-red-600 transition-colors',
      ...
      <button 
        ...
        class="lg:hidden absolute bottom-20 right-4 z-50 w-12 h-12 bg-jd-red text-white rounded-full shadow-lg flex items-center justify-center"
      >
